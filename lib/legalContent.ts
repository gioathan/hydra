...
export const privacyPolicySections: LegalSection[] = [
  ...
  },
  {
    ...
    content:
      "We use local storage and similar technologies to keep you signed in and remember your preferences. You can clear this data at any time through your device settings.",
  },
  {
    title: "Data Security",
    content:
...
export const termsOfServiceSections: LegalSection[] = [
  ...
  },
  {
    ...
    content:
      "Local Bee provides a mobile platform for discovering and booking venues in the Mediterranean. You agree to use the platform only for lawful purposes and in accordance with these terms.",
  },
  {
  ...
  },
  {
    ...
    content:
      "All content on the Local Bee platform, including logos, text, graphics, and software, is the property of Local Bee Mediterranean and is protected by applicable intellectual property laws.",
  },
  {
